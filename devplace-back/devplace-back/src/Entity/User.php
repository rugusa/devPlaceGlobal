...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(mappedBy: 'User', targetEntity: Script::class, orphanRemoval: true)]
    ...
    {
        // If youu store any temporary, sensitive data on the user, clear it here
